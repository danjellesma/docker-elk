...
#### NOTE: This is not the original stack, but a modified version of an existing project.
Please see the original version here: [deviantony/docker-elk](https://github.com/deviantony/docker-elk)
